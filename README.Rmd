...
For subsequent analysis upon getting network enrichment statistics, please use **[tKOIAgent](https://github.com/BaranziniLab/tKOIAgent)** for contextualization and network treversal.

## Documentations
Please refer to **[Documentation](https://broccolito.github.io/software/tkoi/index.html)** for detailed documentation of this R package.
...
* Seamless compatibility with `clusterProfiler`, `enrichplot`, and `ggplot2`
## Getting Started
